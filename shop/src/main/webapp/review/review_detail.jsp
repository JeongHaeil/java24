...
if (review.getReviewStatus() == 2) {//검색된 게시글이 비밀글인 경우
	...
	if (loginMember == null
	|| loginMember.getMemberNum() != review.getReviewMemberNum() && loginMember.getMemberAuth() != 9) {
		request.setAttribute("returnUrl", request.getContextPath() + "/index.jsp?workgroup=error&work=error_400");
		return;
	}
}
...
<div id="review_detail">
	...
	<table>
		<tr>
			<th>작성자</th>
			<td><%=review.getMemberName()%> <%-- 로그인 사용자가 관리자인 경우 --%> <%
		...
		<tr>
			...
			<td>
				...
				<% if(review.getReviewImage() != null) { %>
					<img src="<%=request.getContextPath() %>"/review_images/<%=review.getReviewImage() %>
				<% } %>
			</td>
		</tr>
	</table>
