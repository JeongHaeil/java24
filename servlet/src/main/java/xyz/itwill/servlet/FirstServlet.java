...
//어노테이션(Annotation) : 프로그램 실행에 보조적인 기능을 제공하기 위한 자료형
...
// => 어노테이션 속성은 () 기호안에 작성하며 [,] 기호를 사용해 속성 구분 
// => name 속성 : 서블릿의 이름을 속성값으로 설정 - 속성을 생략한 경우 클래스의 이름을 서블릿
//이름으로 자동설정
...
public class FirstServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//요청에 대한 처리 명령 작성
		//서블릿은 모든 클라이언트에게 일관성 있는 처리결과된 저장한 파일을 동적으로 생성하여 응답
		...
		//SimpleDateFormat 객채에 저장된 패턴의 문자열로 변환하여 반환받아 저장
