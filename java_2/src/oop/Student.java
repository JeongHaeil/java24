...
public class Student {
	...
	//인스턴스 필드 : 객체 생성시 객체에 만들어지는 필드로 객체를 필드사용
	// => 생성자를 사용하여 객체 생성시 필드에 초기값 저장이 가능
	
	private int num;
	private String name;
	private int kor, eng, tot;
	
	//정적 필드 : 클래스 파일을 읽어 메모리(메소드 영역)에 저장될 때 만들어지는 필드
	//클래스로 사용하여 필드에 접근
	...
	//인스턴스 메소드 : this 키워드를 제공받아 사용할수 있는 메소드로 객체를 사용하여 호출한다
	...
	//정적 메소드 : this 키워드를 제공받지 않는 메소드로 클래스로 사용하요 호출	
	// => this 키워드를 사용할수 없으므로 인스턴스 필드 및 인스턴스 메소드 사용 불가능
	// => 정적 필드 및 정적 메소드만 사용가능
