...
//중첩클래스 : 클래스(Outer Class)에 선언된 클래스(Inner Class)
...
public class OuterOne {
	...
	//외부 클래스의 메소드에서는 내부클래스의 필드 또는 메소드를 직접 참조하여 사용 불가능
	...
	// => 객체 내부 클래스는 컴파일되면 [외부클래스$내부클래스.class] 파일로 생성
	// => 외부 클래스에 종속되어 사용되는 클래스 - 외부클래스에서만 사용 가능한 클래스
