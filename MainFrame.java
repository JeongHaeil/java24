...
public class MainFrame extends JFrame {
    ...
    public MainFrame(Dimension size, UserDataSet users) {
        this.users = users;
        init(size);
    }
    ...
    private void init(Dimension size) {
        ...
        shoppingBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                setVisible(false);
                ShoppingListDialog shoppingListDialog = new ShoppingListDialog(MainFrame.this);
    ...
    public JTable getTable() { // getter 메서드 추가
        return table;
    }
}
