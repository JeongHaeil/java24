...
SELECT SUM(SAL),TO_CHAR(HIREDATE,'YYYY'),TO_CHAR(HIREDATE,'MM') FROM EMP GROUP BY TO_CHAR(HIREDATE,'YYYY'),TO_CHAR(HIREDATE,'MM') ORDER BY TO_CHAR(HIREDATE,'YYYY'),TO_CHAR(HIREDATE,'MM');
