...
<%
    ...
    ProductDTO product = ProductDAO.getDAO() selectProduct(cart.getCartProductNum());
        ...
        <div class="contents">
            ...
            <div class="sub_content">
                <div class="content_box">
                    ...
                    <div class="btn_left_box"><a href="cart.jsp" class="shop_go_link">&lt;장바구니 가기</a></div>
                </div>
                ...
                <form action="processOrder.jsp" method="post">
                    ...
                    <div class="payment_final_total">
                        <dl>
                            <dd>
                                <span><strong><%= totalSum %> 원</strong></span>
                                <dt>최종 결제 금액</dt>
                            </dd>
                        </dl>
                    </div>
